...
/**
 * primary export, A class that can be used to parse color strings and represents the color in the RGBA format.
 *
 * @class Color
 */
class Color {
    ...
    /**
     * takes a hex string in the format of #RGB #RGBA #RRGGBB #RRGGBBAA
     *
     * @static
     * @param {string} hexStr
     * @returns {Color}
     ...
     * @returns {Color}
     * @memberof Color
     * @property {boolean} transparent truthy values will result in a random alpha value as well.
     */
    static random(transparent = false) {
        return new Color(Math.random() * 255, Math.random() * 255, Math.random() * 255, transparent ? (Math.random() * 255) : 255);
    }


    //class functions
    /**
     * returns a string version of the represenative color, pass "hex" to get the hex string;
     *
    ...
    /**
     * returns the red value of the color instance
     *
     * @returns {Number}
     * @memberof Color
     */
